...
if __name__ == '__main__':
  ...
  parser.add_argument(
    ...
    default=1000,
    help=
    'number of train steps = num_samples * num_epochs / batch_size / num_workers'
  )
  ...
  parser.add_argument(
    ...
    default=None,
    help=
    'selected cols, for csv input, it is in the format of: label_col_id0,...,lable_cold_idn,feature_col_id '
  ...
  pipeline_config = convert_rtp_fg(
    args.rtp_fg, args.embedding_dim, args.batch_size, args.label,
    args.num_steps, args.model_type, args.separator, args.incol_separator,
    args.train_input_path, args.eval_input_path, args.selected_cols,
