...
def get_params():
    ...
    parser.add_argument(
        '--easyrec_cmd_config', type=str, help='easyrec cmd config path', default='../config/easyrec_cmd_config')
    parser.add_argument(
...
if __name__ == '__main__':
    ...
    try:
        ...
        report_result(filepath, dst_filepath, metric_dict, trial_id, oss_config=args.oss_config)
