...
class BST(object):
    ...
    def __call__(self, inputs, training=None, **kwargs):
        ...
        if self.config.need_contrastive_learning:
            ...
            assert 'cl_params' in kwargs, "no `cl_params` in kwargs of bst layer: %s" % self.name
            cl_param = kwargs['cl_params']
            ...
            loss = self.contrastive_loss(seq_input, seq_len, max_position, weights, cl_param)
