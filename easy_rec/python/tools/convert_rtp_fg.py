...
if __name__ == '__main__':
    ...
    parser.add_argument('--embedding_dim', type=int, default=16, help='embedding_dimension')
    parser.add_argument('--batch_size', type=int, default=1024, help='batch_size for train')
    parser.add_argument('--label', type=str, default='', nargs='+', required=True, help='label fields')
    parser.add_argument(
        '--num_steps',
        type=int,
        default=1000,
    ...
    parser.add_argument('--incol_separator', type=str, default='\003', help='separator for multi_value features')
    parser.add_argument('--separator', type=str, default='\002', help='separator between different features')
    parser.add_argument('--train_input_path', type=str, default=None, help='train data path')
    parser.add_argument('--eval_input_path', type=str, default=None, help='eval data path')
    parser.add_argument(
        '--selected_cols',
        type=str,
        default=None,
    ...
    parser.add_argument('--is_async', action='store_true', help='async mode, debug to false')
    ...
    logging.info('if run on odps, selected_cols must be set, which are label0_col,' 'label1_col, ..., feature_col_name')
