...
class TrainEvalTest(tf.test.TestCase):
  ...
  def test_deepfm_with_lookup_feature(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/deepfm_lookup.config', self._test_dir)
  ...
  def test_deepfm_with_combo_v2_feature(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/deepfm_combo_v2_on_avazu_ctr.config', self._test_dir
    )
    self.assertTrue(self._success)

  def test_deepfm_with_combo_v3_feature(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/deepfm_combo_v3_on_avazu_ctr.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def test_deepfm_with_vocab_list(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/deepfm_vocab_list_on_avazu_ctr.config', self._test_dir
    )
    self.assertTrue(self._success)

  def test_deepfm_with_multi_class(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/deepfm_multi_cls_on_avazu_ctr.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def test_wide_and_deep(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/wide_and_deep_on_avazau_ctr.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def test_dlrm(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/dlrm_on_taobao.config', self._test_dir)
  ...
  def test_deepfm_with_param_edit(self):
    ...
    self._success = test_utils.test_single_train_eval(
      ...
      self._test_dir,
      hyperparam_str='{"model_dir":"%s", ' '"model_config.deepfm.wide_output_dim": 32}' % model_dir,
    )
    self.assertTrue(self._success)
  ...
  def test_multi_tower_backbone(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/multi_tower_backbone_on_taobao.config', self._test_dir
    )
    self.assertTrue(self._success)

  def test_multi_tower_gauc(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/multi_tower_on_taobao_gauc.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def test_multi_tower_save_checkpoint_secs(self):
    ...
    self.assertAllClose(ckpts_times[1:] - ckpts_times[:-1], [20] * (len(ckpts_times) - 1), atol=20)
    self.assertTrue(self._success)
  ...
  def test_latest_ckpt_v2(self):
    def _post_check_func(pipeline_config):
      ...
      logging.info('latest_checkpoint: %s' % estimator_utils.latest_checkpoint(pipeline_config.model_dir))
      return tf.train.latest_checkpoint(pipeline_config.model_dir) == estimator_utils.latest_checkpoint(
  ...
  def test_fine_tune_latest_ckpt_path(self):
    def _post_check_func(pipeline_config):
      ...
      return pipeline_config.train_config.fine_tune_checkpoint == 'data/test/mt_ckpt/model.ckpt-100'
  ...
  def test_fine_tune_ckpt(self):
    def _post_check_func(pipeline_config):
      pipeline_config.train_config.fine_tune_checkpoint = estimator_utils.latest_checkpoint(pipeline_config.model_dir)
  ...
  def test_multi_tower_fg_input(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/taobao_fg.config', self._test_dir)
    self.assertTrue(self._success)

  def test_multi_tower_fg_json_config(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/taobao_fg.json', self._test_dir)
    self.assertTrue(self._success)

  def test_fm(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/fm_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_din(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/din_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_bst(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/bst_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_cl4srec(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/cl4srec_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)

  def test_dcn(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/dcn_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)

  def test_ziln_loss(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/mlp_on_taobao_with_ziln_loss.config', self._test_dir
    )
    self.assertTrue(self._success)

  def test_fibinet(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/fibinet_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)

  def test_masknet(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/masknet_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_dcn_with_f1(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/dcn_f1_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)

  def test_autoint(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/autoint_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)

  def test_uniter(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/uniter_on_movielens.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_cdn(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/cdn_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)

  def test_ppnet(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/ppnet_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_cmbf(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/cmbf_on_movielens.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_dssm(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/dssm_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_dssm_neg_sampler(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/dssm_neg_sampler_on_taobao.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def test_dssm_neg_sampler_v2(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/dssm_neg_sampler_v2_on_taobao.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def _test_kd(self, config0, config1):
    ...
    config_util.save_pipeline_config(pipeline_config, self._test_dir, 'kd_pipeline.config')
    self._success = test_utils.test_single_train_eval(
  ...
  def test_mind(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/mind_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_mmoe(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/mmoe_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_simple_multi_task(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/simple_multi_task_on_taobao.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def test_esmm(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/esmm_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)

  def test_tag_kv_input(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/kv_tag.config', self._test_dir)
    self.assertTrue(self._success)

  def test_aitm(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/aitm_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)

  def test_dbmtl(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/dbmtl_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_early_stop_custom(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/custom_early_stop_on_taobao.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def test_latest_export_with_asset(self):
    self._success = test_utils.test_distributed_train_eval(
      'samples/model_config/din_on_taobao_latest_export.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def test_rocket_launching(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/rocket_launching.config', self._test_dir)
    self.assertTrue(self._success)

  def test_rocket_launching_feature_based(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/rocket_launching_feature_based.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def test_train_with_ps_worker_with_evaluator(self):
    ...
    logging.info('final_export_dir=%s all_saved_files=%s' % (final_export_dir, ','.join(all_saved_files)))
  ...
  def test_share_not_used(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/share_not_used.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_sequence_dcn(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/dcn_on_sequence_feature_taobao.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def test_sequence_ple(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/ple_on_sequence_feature_taobao.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def test_gzip_data(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/din_on_gzip_data.config', self._test_dir)
    self.assertTrue(self._success)

  def test_cmd_config_param(self):
    def _post_check_config(pipeline_config):
      train_saved_config_path = os.path.join(self._test_dir, 'train/pipeline.config')
      pipeline_config = config_util.get_configs_from_pipeline_file(train_saved_config_path)
      assert pipeline_config.model_config.deepfm.wide_output_dim == 8, (
        'invalid model_config.deepfm.wide_output_dim=%d' % pipeline_config.model_config.deepfm.wide_output_dim
      )
  ...
  @unittest.skipIf(hvd is None or sok is None, 'horovod and sok is not installed')
  def test_sok(self):
    self._success = test_utils.test_distributed_train_eval(
  ...
  @unittest.skipIf(six.PY2 or tf_version.split('.')[0] != '2', 'only run on python3 and tf 2.x')
  ...
  def test_pdn(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/pdn_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)
  ...
  def test_dssm_senet_backbone_on_taobao(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/dssm_senet_on_taobao_backbone.config', self._test_dir
    )
    self.assertTrue(self._success)
  ...
  def test_xdeefm_backbone_on_taobao(self):
    self._success = test_utils.test_single_train_eval(
      'samples/model_config/xdeepfm_on_taobao_backbone.config', self._test_dir
    )
    self.assertTrue(self._success)

  @unittest.skipIf(gl is None, 'graphlearn is not installed')
  def test_dat_on_taobao(self):
    self._success = test_utils.test_single_train_eval('samples/model_config/dat_on_taobao.config', self._test_dir)
    self.assertTrue(self._success)
