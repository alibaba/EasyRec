...
def set_eval_input_path(pipeline_config, eval_input_path):
  if pipeline_config.WhichOneof('eval_path') == 'hive_eval_input':
    ...
    logging.info('update hive_train_input.table_name to %s' % pipeline_config.hive_eval_input.table_name)
    ...
    logging.info('update train_input_path to %s' % pipeline_config.eval_input_path)
  return pipeline_config