...
from datahub.exceptions import InvalidOperationException, ResourceExistException
...
class OdpsOSSConfig:
    ...
    def clean_subscription(self, topic_name):
        subscriptions = self.dh.list_subscription(self.dhproject, topic_name, '', 1, 100).subscriptions
    ...
    def _subscription(self):
        ...
        try:
            self.dh.create_tuple_topic(self.dhproject, self.dhtopic, 7, 3, record_schema, 'easyrec_datahub')
