...
if __name__ == '__main__':
    ...
    parser.add_argument('--datahub_config', type=str, default=None, help='datahub_config')
    ...
    start = ['deep_fm/create_external_deepfm_table.sql', 'deep_fm/create_inner_deepfm_table.sql']
    end = ['deep_fm/drop_table.sql']
    odps_cmd = OdpsCommand(odps_oss_config)
