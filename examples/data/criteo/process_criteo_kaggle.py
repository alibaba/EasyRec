...
data_train = pd.read_csv('criteo_kaggle_display/train.txt', sep='\t', names=columns)
...
data_train[train_num:].to_csv(r'criteo_test_data', index=False, sep='\t', mode='a', header=False)
print('Done.')
