...
class RocketLaunching(RankModel):
  ...
  def build_predict_graph(self):
    ...
    self._prediction_dict.update(
      self._output_to_prediction_impl(light_out, self._loss_type, num_class=self._num_class, suffix='_light')
    )
  ...
  def get_outputs(self):
    outputs = []
    outputs.extend(self._get_outputs_impl(self._loss_type, self._num_class, suffix='_light'))
    outputs.extend(self._get_outputs_impl(self._loss_type, self._num_class, suffix='_booster'))
    return outputs
