...
from tensorflow.python.ops import array_ops, embedding_ops, math_ops, sparse_ops
    ...
    with ops.name_scope(name, 'embedding_lookup', embed_tensors + [sparse_ids, sparse_weights]) as scope:
        ...
        if default_id is None:
            ...
            is_row_empty = array_ops.tile(
                array_ops.reshape(is_row_empty, [-1, 1]), array_ops.stack([1, array_ops.shape(result)[1]])
            )
        ...
        final_result = array_ops.reshape(
            ...
            array_ops.concat(
                [
                    array_ops.slice(math_ops.cast(original_shape, dtypes.int32), [0], [original_rank - 1]),
