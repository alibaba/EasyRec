...
from easy_rec.python.layers import dnn, fm, input_layer
...
class DeepFM(RankModel):
    def __init__(self, model_config, feature_configs, features, labels=None, is_training=False):
        ...
        assert (
            self._model_config.WhichOneof('model') == 'deepfm'
    ...
    def build_predict_graph(self):
        ...
        if len(self._model_config.final_dnn.hidden_units) > 0:
            ...
            deep_fea = tf.layers.dense(deep_fea, self._num_class, kernel_regularizer=self._l2_reg, name='deep_logits')
