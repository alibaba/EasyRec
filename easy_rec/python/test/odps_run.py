...
class TestPipelineOnOdps(tf.test.TestCase):
    ...
    def test_deepfm(self):
        start_files = ['deep_fm/create_external_deepfm_table.sql', 'deep_fm/create_inner_deepfm_table.sql']
        test_files = [
    ...
    def test_mmoe(self):
        start_files = ['mmoe/create_external_mmoe_table.sql', 'mmoe/create_inner_mmoe_table.sql']
        test_files = [
    ...
    def test_best_exporter(self):
        ...
        tot = OdpsTest(start_files, test_files, end_file, odps_oss_config)
        tot.start_test()
        config_path = os.path.join(odps_oss_config.temp_dir, 'configs/dwd_avazu_ctr_deepmodel_ext_best_export.config')
        ...
        bucket = get_oss_bucket(
            odps_oss_config.oss_key, odps_oss_config.oss_secret, odps_oss_config.endpoint, odps_oss_config.bucket_name
        )
