...
tf.app.flags.DEFINE_bool('with_header', False, 'whether the input csv file has header')
...
tf.app.flags.DEFINE_string('output_sep', chr(1), 'separator of predict result file')
...
def main(argv):
  if FLAGS.saved_model_dir:
    ...
    if FLAGS.pipeline_config_path:
      ...
      pipeline_config_path = config_util.search_pipeline_config(FLAGS.saved_model_dir)
    ...
    logging.info('input_path = %s, output_path = %s' % (FLAGS.input_path, FLAGS.output_path))
    ...
    pred_result = predict(pipeline_config_path, FLAGS.checkpoint_path, FLAGS.input_path)
