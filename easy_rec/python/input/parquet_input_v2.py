...
class ParquetInputV2(ParquetInput):
  ...
  def _preprocess(self, inputs=None):
    ...
    for fc in self._feature_configs:
      feature_name = fc.feature_name if fc.feature_name != '' else fc.input_names[0]
      ...
      if feature_type in [fc.IdFeature, fc.TagFeature]:
        ...
        if inputs is not None:
          ...
          if input_name0 in placeholders:
            ...
            input_vals = array_ops.placeholder(dtypes.int64, [None], name=input_name0 + '/ids')
            input_lens = array_ops.placeholder(dtypes.int64, [None], name=input_name0 + '/lens')
        ...
        features[feature_name] = tf.RaggedTensor.from_row_lengths(values=input_vals, row_lengths=input_lens)
        ...
        if inputs is not None:
          ...
          if input_name0 in placeholders:
            ...
            if fc.raw_input_dim > 1:
              ...
              input_vals = array_ops.placeholder(dtypes.float32, [None], name=input_name0)
