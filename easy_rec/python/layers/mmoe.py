...
class MMOE:
    def __init__(self, expert_dnn_config, l2_reg, num_task, num_expert=None, name='mmoe', is_training=False):
    ...
    def gate(self, unit, deep_fea, name):
        fea = tf.layers.dense(inputs=deep_fea, units=unit, kernel_regularizer=self._l2_reg, name='%s/dnn' % name)
