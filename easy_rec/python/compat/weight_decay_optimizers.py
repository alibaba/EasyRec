...
from tensorflow.python.training import adam, momentum as momentum_opt, optimizer
...
class MomentumWOptimizer(DecoupledWeightDecayExtension, momentum_opt.MomentumOptimizer):
    ...
    def __init__(self, weight_decay, learning_rate, momentum, use_locking=False, name='MomentumW', use_nesterov=False):
...
class AdamWOptimizer(DecoupledWeightDecayExtension, adam.AdamOptimizer):
    ...
    def __init__(
        self, weight_decay, learning_rate=0.001, beta1=0.9, beta2=0.999, epsilon=1e-8, use_locking=False, name='AdamW'
    ):
