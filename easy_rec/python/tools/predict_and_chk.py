...
if __name__ == '__main__':
  ...
  parser.add_argument('--rtp_separator', type=str, default='', help='separator, default to \\u0001')
  ...
  if len(predictor.input_names) == 1:
    assert len(args.label_id) == 0, 'label_id should not be set if rtp feature format is used.'
